...
Prompt:
```
(contrast retry, options={"outlineRadius":4,"outlineAlpha":0.8400000000000001,"shadowOffset":5,"shadowBlur":5,"shadowAlpha":0.34,"bgLuminance":0.2915319300633023})
```
Issues:
- Low contrast for poop (icon L=0.31 vs bg L=0.29 → weighted Δ=0.17 < 0.18)
...
```
Issues:
- Low contrast for decor_cube (icon L=0.33 vs bg L=0.29 → weighted Δ=0.18 < 0.18)
